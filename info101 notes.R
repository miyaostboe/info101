...
# Exercises
# pic 1 -> rule 3- use consistent names and formulas (inconsistent)
# pic 2 -> rule  2- don't confuse the computer (put multiple values of data 1 type)
# pic 3 -> rule 1- make it a rectangle (multiple headers)
